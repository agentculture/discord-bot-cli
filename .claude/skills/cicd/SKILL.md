...
type: command
description: >
  discord-bot-cli's CI/CD lane, layered on `devex pr`. Delegates lint / open /
  ...
  unresolved threads). Use when: creating PRs in discord-bot-cli, handling
