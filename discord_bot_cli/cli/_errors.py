...
Every failure inside discord-bot-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`discord_bot_cli.cli._output`,
...
# Exit-code policy. Documented in ``discord-bot-cli learn`` output.
# 0      = success
