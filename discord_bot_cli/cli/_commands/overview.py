"""``discord-bot-cli overview`` — read-only descriptive snapshot of the agent.
...
:mod:`discord_bot_cli.cli._commands.cli`).
...
from discord_bot_cli.cli._commands.whoami import report
